...
namespace LD48
{
    public class GameCore : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            m_InternalResolution = new RenderTarget2D(GraphicsDevice, 640, 360);
        ...
        protected override void Update(GameTime p_GameTime)
        {
            ...
            if (m_InputController.IsButtonDown(InputConfiguration.Exit)) {
                Exit();
            }

            if (m_PauseMenu.IsPausedOrTransitioning) {
