...
namespace LD48.Actors.Interactive
{
    ...
    public class InteractiveActor : GameActor
    {
        ...
        private Texture2D m_BubbleTexture;
        ...
        public void Update(GameTime p_Time, in PlayerActor p_Player)
        {
            ...
            if (!IsActive) {
                // Reenable interaction after initial trigger if outside of the zone.
                Enabled = true;
            }
                                 ...
                                 SpriteBatch p_SpriteBatch)
        {
            ...
            if (IsActive && Enabled) {
                p_SpriteBatch.Draw(m_BubbleTexture,  new Vector2(CurrentPosition.X, (int) (CurrentPosition.Y + m_BubbleOffset.Y)), Color.White);
            }
        }
