...
namespace LD48.Framework.Levels
{
    ...
    public class Level : IDisposable
    {
        ...
        protected decimal CurrentResult => decimal.Round(Convert.ToDecimal(m_Table.Compute(Equation, "")), 2);
                                  ...
                                  SpriteFont p_SpriteFont)
        {
            ...
            p_SpriteBatch.DrawString(p_SpriteFont, $"{GoalValue}", new Vector2(650, 950), Color.Black,
                0f,
                Vector2.Zero,
                1f,
                SpriteEffects.None,
                1f);
            p_SpriteBatch.DrawString(p_SpriteFont, $"{CurrentResult}", new Vector2(1100, 950), Color.Black,
                0f,
                Vector2.Zero,
                1f,
                SpriteEffects.None,
            ...
            p_SpriteBatch.DrawString(p_SpriteFont, $"PAR: {LevelPar}", new Vector2(1420, 150), Color.Black,
                0f,
                Vector2.Zero,
                0.75f,
                SpriteEffects.None,
                1f);
            p_SpriteBatch.DrawString(p_SpriteFont, $"CURRENT SCORE: 0", new Vector2(1420, 270), Color.Black,
                0f,
                Vector2.Zero,
                0.5f,
                SpriteEffects.None,
