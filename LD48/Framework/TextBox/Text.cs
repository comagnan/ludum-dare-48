...
namespace LD48.Framework.TextBox
{
    ...
    public class Text
    {
        ...
        public void InsertCharacter(int location, char character)
        {
            ...
            ValidateLength(location, location, 1);
        ...
        public void Replace(int start, int end, string replacement)
        {
            ...
            ValidateLength(start, end, replacement.Length);
        ...
        {
            Length = 0;
            ValidateLength(0, 0, value.Length);
        ...
        private void ValidateLength(int start, int end, int added)
        {
